...
jQuery(document).ready(function($) {
	...
	function ctct_ajax(data, $object) {
		...
		if(parseInt(responseText.code, 10) === 400) {
			...
			error_template = error_template.replace('{heading}', CTCT.text.request_error ).replace('{error_message}', CTCT.text.request_error );

			error_template = error_template.replace('{code}', responseText.code ).replace('{message}', responseText.message[0].error_message.replace(/^.*?:/ig, '') );
