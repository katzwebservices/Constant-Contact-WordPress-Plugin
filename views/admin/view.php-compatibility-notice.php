<div class="inline" style="border: 1px solid #ccc; margin:10px 0; padding: 10px; border-radius:5px; background-color:white; ">
	...
	<p><strong><?php _e('We apologize for the inconvenience, but technical requirements changed.', 'constant-contact-api'); ?></strong><?php echo esc_html( sprintf( __('The good news? Once you upgrade your PHP version, your site will be faster %sand more secure%s.', 'constant-contact-api'), '<a href="http://php.net/supported-versions.php">', '</a>' ) ); ?></p>
	...
	<ul class="ul-disc">
		...
		<li><?php esc_html_e('Running a local installation?', 'constant-contact-api'); ?>
			<ul>
