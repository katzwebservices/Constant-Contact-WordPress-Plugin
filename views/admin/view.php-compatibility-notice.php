<div class="inline" style="border: 1px solid #ccc; margin:10px 0; padding: 10px; border-radius:5px; background-color:white; ">
	...
	<p><?php _e('Starting with Version 3.2, <strong>the Contstant Contact Plugin requires PHP Version 5.4 or higher</strong>. Please contact your hosting provider support and ask them to upgrade your server.', 'ctct'); ?></p>
