<div class="inline" style="border: 1px solid #ccc; margin:10px 0; padding:0 10px; border-radius:5px;">
	...
	<p><?php _e('Starting with Version 3.0, <strong>the Contstant Contact Plugin requires PHP Version 5.3 or higher</strong>. Please contact your hosting provider support and ask them to upgrade your server.', 'constant-contact-api'); ?></p>
	...
	<ol>
		<li><?php echo __(sprintf('<a href="%s">Download Version 2.4.1</a>', 'http://downloads.wordpress.org/plugin/constant-contact-api.2.4.1.zip'), 'constant-contact-api'); ?></li>
		...
		<li><?php _e('Delete this plugin (Constant Contact API) by clicking the "Delete" link next to the plugin.', 'constant-contact-api'); ?></li>
