...
class constant_contact_events_widget extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct( false, __('Constant Contact Events', 'constant-contact-api'), $widget_options, $control_options);
  ...
  /** @see WP_Widget::form */
	...
	<table class="form-table">
		...
		<tr valign="top">
			<th scope="row"><p><label for="<?php echo $this->get_field_id('limit');?>"><span><?php _e('<span title="Number">#</span> of Events Shown', 'constant-contact-api'); ?></span></label></p></th>
			<td>
