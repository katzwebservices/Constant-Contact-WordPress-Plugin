...
if(isset($_REQUEST['start']) && isset($_REQUEST['end'])) {
	$height = (isset($_REQUEST['height']) && $_REQUEST['height'] !== '') ? $_REQUEST['height'] : 100;
	$width = (isset($_REQUEST['width']) && $_REQUEST['width'] !== '') ? $_REQUEST['width'] : 1;
	$type = (isset($_REQUEST['type']) && $_REQUEST['type'] !== '') ? $_REQUEST['type'] : 'vertical';
	$image = new gd_gradient_fill($width,$height,$type,$_REQUEST['start'],$_REQUEST['end'],0);
	return false;
}
