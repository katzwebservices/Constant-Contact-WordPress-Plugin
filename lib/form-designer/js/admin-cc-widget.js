...
jQuery(document).ready(function($) {
	...
	$('body').on('click', '.widget a.moreInfo', function(e) {
		e.preventDefault();
		$(this).parents('div.widget').find('div#'+$(this).attr('href')).slideToggle();
		return false;
	})

	$('body').on('load change click ccwidgetsaved', 'input[type=checkbox].list-selection', function() {
		var $that = $(this);
...
jQuery(document).ajaxSuccess(function(e, xhr, settings) {
	var widget_id_base = 'CTCT_Form_Designer_Widget';
